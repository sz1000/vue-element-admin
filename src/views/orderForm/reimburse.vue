<template>
  <div class="contant-container" style="margin-top:30px;">
    <div class="earning">
        ...
        <div class="earning-intro" style=" background:rgba(247,247,247,1); width:873px; height:60px;line-height:60px; text-align:left; padding-left:30px;">当前订单状态：已退款</div>
      ...
      <div class="earning-content" >
        ...
        <div class="earning-intro">
          ...
          <p style="width:300px;">
            <span style="font-weight:500">退款时间：</span>
            <span style="font-weight:500">{{ this.refund_time }}</span>
          </p>
        </div>
      </div>
...
export default {
  ...
  methods: {
    async initData() {
      ...
      this.refund_time = serveData.data.refund_time
    ...
    // 点击立即发货接口
    async toGoods(page, status, seartch) {
