<template>
  <div class="contant-container" style="margin-top:30px;">
    <div class="earning">
        ...
        <div class="earning-intro" style=" background:rgba(247,247,247,1); width:873px; height:60px;line-height:60px; text-align:left; padding-left:30px;">当前订单状态：已核销</div>
      
        <div class="earning-intro contentCode" style=" background:rgba(247,247,247,1); width:873px; height:60px;line-height:60px; text-align:left; padding-left:30px;">
        <!-- <div class="contentCode"> 核销码：{{secret_key}}</div> -->
          核销码：{{secret_key}}
          </div>
      ...
      <div class="earning-content" >
        ...
        <div class="earning-intro">
          ...
          <p style="width:300px;">
            <span style="font-weight:500">核销时间：</span>
