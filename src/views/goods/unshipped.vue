  ...
  <div class="contant-container" style="margin-top:30px;">
    <div class="earning">
      <div class="earning-content" >
        ...
        <div class="earning-intro" style=" background:rgba(247,247,247,1); width:873px; height:60px;line-height:60px; text-align:left; padding-left:30px;">当前发货状态：待发货</div>
        <TitleTabs text="收货信息" />
      ...
      <div class="mes">
        <el-input
          ...
          placeholder="请输入物流公司"
        />
        <el-input ref="logistics_num" v-model="logistics_num" style="width:260px;" placeholder="请输入物流编号"/>
        <el-button type="primary" @click="immediateDelivery">立即发货</el-button>
      </div>
  ...
  methods: {
    ...
    immediateDelivery() {
      ...
      if (this.logistics_num==""  ) {
        ...
        if (!reg.test(this.logistics_num) ) {
