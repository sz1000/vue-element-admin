 ...
 <div class="contant-container" style="margin-top:30px;">
    <div class="earning">
      <div class="earning-content" >
        ...
        <div class="earning-intro" style=" background:rgba(247,247,247,1); width:873px; height:60px;line-height:60px; text-align:left; padding-left:30px;">当前发货状态：已退货</div>
        <TitleTabs text="收货信息" />
        ...
        <div class="earning-intro">
          ...
          <div class="mes">
            ...
            style="width:260px;" v-model="logistics_num" placeholder="请输入物流编号" ></el-input>
              <el-button type="info" :disabled="true">已退货</el-button>
          </div>
