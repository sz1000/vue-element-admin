   ...
   <div class="contant-container" style="margin-top:30px;">
    <div class="earning">
      <div class="earning-content" >
        ...
        <div class="earning-intro" style=" background:rgba(247,247,247,1); width:873px; height:60px;line-height:60px; text-align:left; padding-left:30px;">当前发货状态：已完成</div>
        <TitleTabs text="收货信息" />
        ...
        <div class="earning-intro">
          ...
          <p style="font-weight:500">{{this.address}}</p>
           ...
           <div class="mes">
            ...
            <el-input  
            :disabled="true"
            style="width:260px;" v-model="logistics_num" placeholder="请输入物流编号" ></el-input>
  ...
  methods: {
    async initData() {
      ...
      // this.avatar = serveData.data.userInfo.avatar;
       this.avatar = serveData.data.userInfo?serveData.data.userInfo.avatar:null;

      // this.nick_name = serveData.data.userInfo.nick_name;
      this.nick_name = serveData.data.userInfo?serveData.data.userInfo.nick_name:null;
